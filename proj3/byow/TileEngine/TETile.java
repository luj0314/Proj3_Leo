...
public class TETile {
    private final Character character; // Do not rename character or the autograder will break.
     ...
     */
    public TETile(Character character, Color textColor, Color backgroundColor, String description,
                  String filepath) {
